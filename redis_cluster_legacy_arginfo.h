...
//dkmods
#define arginfo_class_RedisCluster_sremint arginfo_class_RedisCluster_lpush 
...
//dkmods
	ZEND_ME(RedisCluster, sremint, arginfo_class_RedisCluster_sremint, ZEND_ACC_PUBLIC) 
